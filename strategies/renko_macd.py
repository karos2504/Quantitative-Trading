...
from core.math_utils import calculate_matrix_ols_slope, calculate_hw_trend, renko_momentum
...
def _bull_score(row, er_th):
    """
    Returns (bull_score, bear_score). Max score is 6.
    Weights: renko_mom=2 (strong) / 1 (weak), hist_slope=2, ER=2.
    """
    bull, bear = 0, 0
